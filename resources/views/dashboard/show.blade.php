      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <!-- form start -->
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="home_phone" class="form-control" id="home_phone" placeholder="Home Phone" disabled value="{{ $biodata->home_phone }}">
                  </div>
                  <div class="form-group">
                    <label for="cell_phone">Cell Phone</label>
                    <input type="number" name="cell_phone" class="form-control" id="cell_phone" placeholder="Cell Phone" disabled value="{{ $biodata->cell_phone }}">
                  </div>
                  <div class="form-group">
            ...
            <a href="{{ route('dashboard.index') }}" class="btn btn-info">Back</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
